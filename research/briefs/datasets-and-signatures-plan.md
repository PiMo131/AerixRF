...
| **DJI DroneID (O1-O3)** | 2.4/5.8 GHz | 7 candidate 2.4GHz centres (2399.5-2474.5MHz, union of 2 disagreeing lists), 12 candidate 5.8GHz centres (2 lists disagree on all but one point) | burst interval **640ms measured** (NDSS'23, PRIMARY PAPER); no disclosed hop pattern | 9-symbol OFDM burst | ~15.36 MHz occupied (1024 FFT, 15kHz SCS, 601 active subcarriers) | OFDM/QPSK, LTE Turbo coding | bursty, non-continuous | **PRIMARY PAPER (burst interval/OFDM params); COMMUNITY (raster, empirical scan lists)** | `briefs/droneid-channel-raster.md`, `briefs/dji-ocusync-droneid-sources.md` |
