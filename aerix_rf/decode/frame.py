...
OFF_HEIGHT = 31           # i16 (RUB-SysSec calls offset 31 "altitude"; we follow proto17's height/altitude naming -- offsets match, labels are swapped)
OFF_ALTITUDE = 33         # i16 (RUB-SysSec calls offset 33 "height"; same offset, label swapped vs. our proto17-convention name)
OFF_VEL_N = 35            # i16
OFF_VEL_E = 37            # i16
OFF_VEL_U = 39            # i16
OFF_YAW = 41              # i16
