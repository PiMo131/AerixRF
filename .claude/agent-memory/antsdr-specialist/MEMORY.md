...
- [UHD SD-trial prep](uhd_sd_trial_prep.md) — image identified+downloaded, fork host build fixed (cmake policy, boost 1.84 pin) + running, accept.sh written, decision rule for UHD vs IIO (2026-09-19)
