...
**How to apply:** attach the relevant flag to any decode recommendation and state it is blocking; never present a flagged capability as available. Related: [[protocol-non-dji-decodability]].
